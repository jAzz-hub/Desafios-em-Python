...
def Transitividade(matriz):
  ...
  if(len(matriz)<3):
    ...
    print(espelho, "+Existem+>", verdades, "VERDADES")
...
c = 0
n = int(input("Quantos elementos existem na relação?"))
copias = 0
r = []
...
while(c<n):
  ...
  a = (int(input("insira o elemento a:")))
  b = (int(input("insira o elemento b:")))
